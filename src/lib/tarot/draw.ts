...
const SPREADS: Record<string, { name: string; positions: string }> = {
  ...
  horseshoe: ("马蹄形", "远期过去,0,0|近期过去,0,0|当前,1,0|近期未来,0,0|外部影响,1,0|建议,0,1|结果,1,1"),
  celtic:  ("凯尔特十字", "核心,1,0|交叉,0,0|意识目标,0,0|根基过去,0,0|近期过去,1,0|近期未来,0,0|自我,0,0|环境,0,0|希望与恐惧,0,0|结果,1,1"),
}
