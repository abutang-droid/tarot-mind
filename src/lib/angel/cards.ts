...
export interface AngelCard {
  ...
  color: string        // 卡牌主色
  symbol: string       // SVG 符号标识
  affirmation: string  // 正念肯定语
  message: string      // 天使讯息
  guidance: string     // 行动指引
  keywords: string[]
}
...
export const ANGEL_CARDS: AngelCard[] = [
  // ── 光之天使（Light Angels）──────────────────────────────────────
  {
    ...
    name: '大天使米迦勒', nameEn: 'Archangel Michael',
